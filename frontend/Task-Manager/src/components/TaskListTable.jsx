            ...
            <table className="min-w-full">
                <thead >
                    <tr className="text-left">
                        <th className="px-6 py-3 text-[13px] font-medium text-gray-800">Name</th>
                        <th className="px-6 py-3 text-[13px] font-medium text-gray-800">Status</th>
                        <th className="px-6 py-3 text-[13px] font-medium text-gray-800">Priority</th>
                        <th className="px-6 py-3 text-[13px] font-medium text-gray-800 hidden md:table-cell">Created On</th>
                    </tr>
                </thead>
                <tbody>
                    {tableData.map((task) => (
                        <tr key={task._id} className="border-t border-gray-200">
                            ...
                            <td className="px-4 py-4 text-gray-700 text-[13px] text-nowrap hidden md:table-cell">{task.createdAt ? moment(task.createdAt).format('YYYY-MM-DD') : 'N/A'}</td>
                        </tr>
                    ))}
                </tbody>
            </table>
